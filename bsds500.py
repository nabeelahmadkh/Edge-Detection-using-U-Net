...
class BSDS500(object):
    BUCKET = 'i008data'
    FN = 'BSR_bsds500.tgz'
    STORE_FN = os.path.join(os.environ['USERPROFILE'], 'BSR.tgz')
    ...
    def __init__(self, path_to_bsds=None, images_to_gray=False, target_size=None, masks_to_binary=True):
        ...
        self.VALID_PATH = 'data/images/val/'
        self.GROUND_TRUTH_TRAIN = 'data/groundTruth/train/'
        self.GROUND_TRUTH_TEST = 'data/groundTruth/test/'
        self.GROUND_TRUTH_VALID = 'data/groundTruth/val/'


    # Only get called if the images path is not there
    def get_bsds(self):
